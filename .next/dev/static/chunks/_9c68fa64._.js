...
const translations = {
    en: {
        ...
        about_me: "About Me",
        welcome: "Welcome",
        explore_sections: "Explore what's here",
        contact: "Contact",
    ...
    mm: {
        ...
        article_analysis_title: "ဆောင်းပါးခွဲခြမ်းစိတ်ဖြာခြင်း",
        ...
        analyze_article: "ဆောင်းပါးခွဲခြမ်းစိတ်ဖြာရန်",
...
function ApiProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ApiProvider.useEffect": ()=>{
            ...
            const storedModel = localStorage.getItem('user_gemini_model');
            const today = new Date().toDateString();
            const lastUsageDate = localStorage.getItem('gemini_usage_date');
            const storedUsage = parseInt(localStorage.getItem('gemini_daily_usage') || '0', 10);
            const storedTokens = parseInt(localStorage.getItem('gemini_daily_tokens') || '0', 10);
            if (lastUsageDate !== today) {
                setDailyUsage(0);
                setDailyTokens(0);
                localStorage.setItem('gemini_daily_usage', '0');
                localStorage.setItem('gemini_daily_tokens', '0');
                localStorage.setItem('gemini_usage_date', today);
            } else {
                setDailyUsage(storedUsage);
                setDailyTokens(storedTokens);
            }
            if (storedModel) setModelState(storedModel);
            if (storedKey) {
                setApiKeyState(storedKey);
                validateInternal(storedKey).then({
                    "ApiProvider.useEffect": (valid)=>setIsValid(valid)
                }["ApiProvider.useEffect"]);
            }
        }
    }["ApiProvider.useEffect"], []);
    const incrementUsage = (metadata)=>{
        const tokens = metadata?.totalTokenCount || metadata?.total_tokens || 0;
        const now = Date.now();
        setDailyUsage((prev)=>{
            const newVal = prev + 1;
            localStorage.setItem('gemini_daily_usage', newVal.toString());
            return newVal;
        });
        setDailyTokens((prev)=>{
            const newVal = prev + tokens;
            localStorage.setItem('gemini_daily_tokens', newVal.toString());
            return newVal;
        });
        setRecentCalls((prev)=>[
                ...prev,
...
_s(ApiProvider, "U6WCQqHVn8XrNfcAsT10p2SAgck=");
_c = ApiProvider;
function useApi() {
    _s1();
...
_s(LanguageProvider, "jafHzYHzII4ZGNmkZrw+c+xorUI=", false, function() {
    return [
...
function LanguageToggle() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: "text-[10px] font-bold tracking-[0.2em] uppercase hover:opacity-50 transition-opacity flex items-center gap-1",
        "aria-label": "Toggle language",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: language === 'en' ? 'text-foreground' : 'text-foreground/30',
                children: "EN"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: language === 'mm' ? 'text-foreground' : 'text-foreground/30',
                children: "MM"
            }, void 0, false, {
                fileName: "[project]/components/LanguageToggle.tsx",
                lineNumber: 17,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "AI Engine Health • Real-time Monitoring"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/UserAuth.tsx",
                                                        lineNumber: 319,
                                                        columnNumber: 25
                                ...
                                children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "Access your global persona"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/UserAuth.tsx",
                                                        lineNumber: 382,
                                                        columnNumber: 23
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    ...
                                                    mode === 'login' ? 'Authenticate' : 'Forge Identity'
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/components/UserAuth.tsx",
                                                lineNumber: 447,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: mode === 'login' ? "Require New Persona?" : "Known Entity?"
                                        }, void 0, false, {
                                            fileName: "[project]/components/UserAuth.tsx",
                                            lineNumber: 477,
                                            columnNumber: 21
...
_s(UserAuth, "ilSh1ohtyg5NJDsfWO2ERct5SYM=");
_c = UserAuth;
var _c;
                                                ...
                                                'article-analysis'
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].span, {
                                                            ...
                                                            children: item === 'ereader' ? 'e-reader' : item
                                                        }, void 0, false, {
                                                            fileName: "[project]/components/SidePanel.tsx",
                                                            lineNumber: 211,
                                                            columnNumber: 25
...
_s(SidePanel, "jw0lV5cy5qwlUDWT3C0L4H59xmo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ApiContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApi"]
    ];
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Precision API Monitoring Active"
                    }, void 0, false, {
                        fileName: "[project]/components/ApiHealthBar.tsx",
                        lineNumber: 85,
                        columnNumber: 10
...
_s(ApiHealthBar, "IOVhglXugrTp91SypOCZO5wZIP4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ApiContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApi"]
    ];
});
...
function Header() {
    ...
    const baseLogo = "adrian.vlog";
    const logoText = profile?.name ? `${profile.name}.vibe` : baseLogo;
...
_s(TranslationDrawer, "phdNgS00OBqpE8poGChCIAi1mTU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ApiContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApi"]
    ];
});
...
//# sourceMappingURL=_9c68fa64._.js.map